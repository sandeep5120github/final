...
class Config(object):
    API_ID = int(os.getenv("API_ID", "10079307"))
    API_HASH = os.getenv("API_HASH", "eccafbdbe5ebb0df40241596e95d5912")
    BOT_TOKEN = os.getenv("BOT_TOKEN", "6276473344:AAHR7bDQbrdCJV1v4lgupUeGhmrxsYnwdTU")
...
ꜰᴏʀ ᴍᴏʀᴇ ɪɴꜰᴏ ᴄʟɪᴄᴋ ᴏɴ ʜᴇʟᴘ ✅""" )
    UPDATES_CHANNEL = os.getenv("UPDATES_CHANNEL", "-1001897374182")
    DATABASE_URL = os.getenv("DATABASE_URL", "mongodb+srv://sandeep51208:Pubg.com123@cluster0.cjuz82f.mongodb.net/?retryWrites=true&w=majority")
    LOG_CHANNEL = int(os.getenv("LOG_CHANNEL", "-1001539199443"))
    RESULTS_COUNT = int(os.getenv("RESULTS_COUNT", 20))
    BROADCAST_AS_COPY = os.getenv("BROADCAST_AS_COPY", "True")
    UPDATES_CHANNEL_USERNAME = os.getenv("UPDATES_CHANNEL_USERNAME", "SandeepXMovies")
...
ᴅᴍ ꜰᴏʀ ᴀɴʏ Qᴜᴇʀʏ @itz_sandeep512 🤖""" )
    ABOUT_WATCH_TEXT = """
ʜᴇʏ ʙᴜᴅᴅʏ, 
